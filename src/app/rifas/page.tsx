      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {loading ? (
          <div className="text-center py-12">
            <p className="text-2xl font-bold text-gray-700">⏳ Carregando rifas...</p>
          </div>
          ...
          <div className="text-center py-12">
            <p className="text-2xl font-bold text-gray-700">😔 {searchTerm ? 'Nenhuma rifa encontrada' : 'Nenhuma rifa disponível'}</p>
