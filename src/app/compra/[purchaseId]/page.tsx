...
import { ArrowLeft, Ticket, Calendar, DollarSign, CheckCircle2, AlertCircle } from 'lucide-react'
      ...
      try {
        ...
        if (authUser) {
          ...
          if (response.ok) {
            ...
            const foundPurchase = purchases.find((p: Purchase) => p.id === purchaseId)
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 text-center">
              ...
              <p className="text-gray-900 font-bold text-lg">{error || 'Compra não encontrada'}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 mb-8">
            <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200">
              ...
              <div className="flex-1">
                <h1 className="text-3xl font-black text-gray-900">Detalhes da Compra</h1>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-3xl font-black text-emerald-700">R$ {Number(purchase.amount).toFixed(2)}</p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              ...
              <p className="text-gray-900 font-black">
                {purchaseDate.toLocaleDateString('pt-BR')} às {purchaseDate.toLocaleTimeString('pt-BR')}
              </p>
            </div>
            ...
            <div className="border-t border-gray-200 pt-8">
              <h3 className="text-sm font-bold text-gray-600 mb-4">Dados do Comprador</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <p className="text-gray-600">Nome:</p>
                  <p className="text-gray-900 font-bold">{censorName(user.name)}</p>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <p className="text-gray-600">Telefone:</p>
                  <p className="text-gray-900 font-bold">{censorPhone(user.phone)}</p>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
