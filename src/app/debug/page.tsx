...
export default function DebugPage() {
  ...
  return (
    <div className="p-8 space-y-4 text-slate-900">
      ...
      <div className="bg-fundo-cinza p-4 rounded">
        <h2 className="font-bold mb-2">Context State:</h2>
        <pre className="bg-branco p-2 rounded text-xs overflow-auto">
{JSON.stringify({
  user,
  isAuthenticated,
  loading
...
{JSON.stringify({
  ...
  token: storageToken ? `${storageToken.substring(0, 20)}...` : null
      ...
      <button 
        ...
        className="bg-vermelho-claro text-branco px-4 py-2 rounded font-bold hover:bg-vermelho-vivo"
      >
        Limpar localStorage
      </button>
    </div>
