...
export default function PurchaseDetailPage({
  ...
  const cliente = typeof routeParams?.cliente === 'string' ? routeParams.cliente : '';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-5">
                <a href={`/${cliente}/account`} className=" items-center gap-2 text-azul-royal dark:text-amarelo-claro text-1xl font-bold inline-flex transition">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            href={
              authUser
                ...
                : referrer === "meus-bilhetes-resultado"
                  ? `/${cliente}/meus-bilhetes/resultado`
                  : `/${cliente}/meus-bilhetes`
            }
          ...
          {authUser && (
            <div className="grid grid-cols-2 gap-4">
              ...
              {purchase.raffleId && (
                <Link
                  href={`/${cliente}/lotes/${purchase.raffleId}`}
