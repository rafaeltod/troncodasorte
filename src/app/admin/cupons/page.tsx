...
import { Plus, Edit, Trash2, Tag, Users, Eye, DollarSign, ArrowLeft, Copy, Check, X, Search } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto py-8 px-4">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {cupons.map(cupom => (
                <div key={cupom.id} className={`bg-white rounded-xl shadow border ${cupom.ativo ? 'border-gray-200' : 'border-red-200 bg-red-50/30'} p-6`}>
