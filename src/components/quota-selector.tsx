...
export function QuotaSelector({ onSelect, selectedQuantity, availableQuotas }: QuotaSelectorProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
      <h3 className="text-2xl font-black text-gray-900 mb-6">Selecione a quantidade</h3>
        ...
        {presetOptions.map((quantity) => {
          ...
          return (
            <button
              ...
              disabled={isDisabled}
              className={`py-4 px-3 rounded-xl font-bold text-lg transition transform ${
                isDisabled
      ...
      <div className="space-y-3">
        <p className="text-sm font-bold text-gray-900">Ou insira a quantidade total:</p>
