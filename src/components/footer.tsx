  ...
  return (
    <footer className={`${mainConfig} flex justify-between items-center bg-branco dark:bg-cinza-escuro text-cinza text-1xl dark:text-branco lg:px-12 pt-8 pb-8 flex-wrap`}>
        ...
        <ol className='flex gap-4'>
            <li><a href="https://www.instagram.com/troncodasorte/" target="_blank" rel="noopener noreferrer" className='flex dark:text-branco items-center text-1xl gap-1 hover:text-azul-claro'><Instagram className='w-[15px] h-[15px]'/>Instagram</a></li>
        </ol>
